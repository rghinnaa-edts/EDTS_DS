...
public class KlikIDM_DSCoachmark: UIView {
    ...
    @IBOutlet var btnSkip: KlikIDM_DSButton!
    @IBOutlet var btnNext: KlikIDM_DSButton!
    ...
    private func setupUI() {
        ...
        vIconBackground.backgroundColor = UIColor.grey20
    ...
    private func setupDescription(_ config: CoachmarkStepConfig) {
        if config.description == nil, let attributed = config.descriptionAttributted {
            ...
            mutable.enumerateAttribute(.font, in: fullRange) { value, range, _ in
                ...
                mutable.addAttribute(.foregroundColor, value: UIColor.grey60 ?? .gray, range: range)
            }
