...
class PromoGiftViewController: UIViewController {
    ...
    @IBOutlet var vTabTop: EDTSTabQuadRound!
    @IBOutlet var vTab: EDTSTabDefault!
    ...
    var tabItems: [EDTSTabQuadRoundModel] = []
    ...
    private func setupTab() {
        ...
        vTab.registerCellType(EDTSTabDefaultCell.self, withIdentifier: "EDTSTabDefaultCell")
    ...
    private func loadData() {
        tabItems = [
            EDTSTabQuadRoundModel(id: "1", title: "Tebus Murah", badge: 3),
            EDTSTabQuadRoundModel(id: "2", title: "Cuci Gudang 2025", badge: 1),
            EDTSTabQuadRoundModel(id: "3", title: "Hadiah Produk", badge: 3),
            EDTSTabQuadRoundModel(id: "4", title: "Get Kupon", badge: 1),
            EDTSTabQuadRoundModel(id: "5", title: "Tebus Murah", badge: 3),
            EDTSTabQuadRoundModel(id: "6", title: "Cuci Gudang", badge: 1)
        ]
        
        items1 = [
            PromoGiftModel(
                chip: EDTSTabDefaultModel(
                    id: "1",
                    title: "Paragon Fair"),
...
extension PromoGiftViewController: EDTSTabDefaultDelegate {
    func didSelectTabDefault(at index: Int, withId id: String, cellIdentifier cellIdentifer: String) {
...
extension PromoGiftViewController: EDTSTabQuadRoundDelegate {
