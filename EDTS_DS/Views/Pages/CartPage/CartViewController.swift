...
class EDTSCartViewController: UIViewController {
    ...
    @IBOutlet var loadingPromoTop: EDTSSkeleton!
    @IBOutlet var loadingPromo: EDTSSkeleton!
...
extension EDTSCartViewController: UIScrollViewDelegate {
