...
| Leading icon tint | `iconLeadingColor` · `iconLeadingFocusColor` · `iconLeadingErrorColor` · `iconLeadingDisabledColor` |
| Trailing icon tint | `iconTrailingColor` · `iconTrailingFocusColor` · `iconTrailingErrorColor` · `iconTrailingDisabledColor` |
