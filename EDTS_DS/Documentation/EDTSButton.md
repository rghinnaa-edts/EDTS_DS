...
| `Ripple Effect` | `400ms expand + 220ms fade out` | `EaseOut` | Full-component ripple from touch point on tap (unless a gradient background (bgColorStart / bgColorEnd) is set) |
