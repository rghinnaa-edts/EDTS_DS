...
| -------------- | -------- | ------------ | ----------- |
| `State Transition` | `250ms` | `EaseInOut` | Animates colors, borders, and backgrounds when toggling between active/inactive |
| `Ripple Effect` | `400ms` | `EaseOut` | Full ripple animation on chip tap, circle ripple on icon tap |
